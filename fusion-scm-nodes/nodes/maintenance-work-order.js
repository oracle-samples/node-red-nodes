...
module.exports = function(RED) {
    ...
    function MaintenanceWorkOrderNode(config) {
        ...
        node.on("input", async function(msg, send, done) {
            try {
                ...
                var outMsg = Object.assign({}, msg, {
                    ...
                    maintenanceWorkOrder: response.data
                });
    ...
    function resolveAction(config, msg) {
        ...
        if (action !== "create" && action !== "update") {
            throwValidationError("Maintenance Work Order action must be create or update");
        }
        return action;
    }
    ...
    function throwValidationError(message) {
        ...
        err.maintenanceWorkOrderValidationError = true;
        throw err;
    }
    ...
    RED.nodes.registerType("maintenance-work-order", MaintenanceWorkOrderNode);
};
